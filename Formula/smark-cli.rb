...
class SmarkCli < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/shieldmark-io/smark-cli/releases/download/v0.7.0/smark-cli-0.7.0-darwin-arm64.tar.gz"
      sha256 "c571ff23c11f65183c84d77fadeb708e50aa424666f31800574ea514be122031"
    end
    if Hardware::CPU.intel?
      url "https://github.com/shieldmark-io/smark-cli/releases/download/v0.7.0/smark-cli-0.7.0-darwin-x64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/shieldmark-io/smark-cli/releases/download/v0.7.0/smark-cli-0.7.0-linux-arm64.tar.gz"
      sha256 "baf2b6f510f1413d5df4fcd360c6d6b2c4fe291067252698781bba849717ce37"
    end
    if Hardware::CPU.intel?
      url "https://github.com/shieldmark-io/smark-cli/releases/download/v0.7.0/smark-cli-0.7.0-linux-x64.tar.gz"
